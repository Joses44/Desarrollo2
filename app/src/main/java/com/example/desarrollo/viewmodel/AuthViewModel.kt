...
class AuthViewModel : ViewModel() {
    ...
    // LiveData para los mensajes de error de inicio de sesión
    ...
    // LiveData para los campos del formulario de registro
    ...
    // LiveData para los mensajes de error de registro
